## My answer
Please run `main.py` with the invluded venv. `tail -f` the `.log` file. Issue `curl localhost:3000` command to receive reply.

Thank you very much, Ben, for the opportunity!! I hope this is okay.

I wasn't sure what the best practices are for module/class separation, or for logging, I hope to learn all those things and more from you guys! 
